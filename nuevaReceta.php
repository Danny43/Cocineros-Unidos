    ...
    <script>
        ...
        $(document).ready(function (e) {
            ...
            $('#agregar').click(function (e) {
                ...
                var filaNueva = "<tr>" +
                        "<td><select onclick=clickaction(this.id) name='ingrediente' id='" + i + "'>\n\
            <?php 
            ...
            ?></select><div class='textoError' id='" +
                        "l" + i + "'></div></td>" +
                        "<td><input onclick=clickaction(this.id) class='gusto' id='" + (i + 1) + "' /><div class='textoError' id='" + "g" + (i + 1) + "'></div></td>" +
