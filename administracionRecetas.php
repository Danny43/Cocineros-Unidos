                    ...
                    <div class="col-lg-10 mx-auto">
                        <div class="card w-100 tarjetaInicioSesion animated bounceInDown">
                            <div class="card-body">
                                ...
                                <h2 class="titulo">Administracion Recetas</h2>                                                                  
                                <div class="contenedorBotones">
                                    <div class="btn-group-lg">
                                        <a href="nuevaReceta.php" class="btn btn-primary">Nueva Receta</a>
                                        <a href="buscarRecetas.php" class="btn btn-primary">Buscar</a>
                                        <a href="verTodasRecetas.php" class="btn btn-primary">Ver Todos</a>
                                    </div>
                                </div>                                 
                            </div>
