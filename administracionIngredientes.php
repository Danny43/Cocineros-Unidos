                    ...
                    <div class="col-lg-10 mx-auto">
                        <div class="card w-100 tarjetaInicioSesion animated bounceInDown">
                            <div class="card-body">
                                ...
                                <h2 class="titulo">Administracion Ingredientes</h2>                                                                  
                                <div class="contenedorBotones">
                                    <div class="btn-group-lg">
                                        <a href="nuevoIngrediente.php" class="btn btn-primary">Nuevo Ingrediente</a>
                                        <a href="buscarIngredientes.php" class="btn btn-primary">Buscar</a>
                                        <a href="verTodosIngredientes.php" class="btn btn-primary">Ver Todos</a>
                                    </div>
                                </div>                                 
                            </div>
                        </div>
